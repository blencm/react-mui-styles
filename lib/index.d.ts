import { StyleSheetFactoryOptions, GenerateId, Jss } from 'jss';
import { Theme } from '@mui/material';
export { Theme as DefaultTheme, ThemeProvider } from '@mui/material';
...
interface WithStylesOptions<Theme = Theme> extends StyleSheetFactoryOptions {
    defaultTheme?: Theme;
    flip?: boolean;
    withTheme?: boolean;
    name?: string;
...
declare function getThemeProps<
  Theme extends ThemeWithProps<any>,
  Props,
  Name extends keyof any,
>(params: { props: Props; name: Name; theme?: Theme }): Props & ThemedProps<Theme, Name>;

declare function jssPreset(): {
    plugins: any[];
};

type ClassNameMake<ClassKey extends string = string> = Record<ClassKey, string>;

declare function makeStylesmakeStyles<Theme = Theme, Props extends object = {}, ClassKey extends string = string>(stylesOrCreator: Styles<Theme, Props, ClassKey>, options?: Omit<WithStylesOptions<Theme>, 'withTheme'> | any): (props?: any) => ClassNameMake<ClassKey>;
...
interface MergeClassesOption {
    ...
    Component?: ElementType | null | any;
}
...
declare class ServerStyleSheets$1 {
    constructor(options?: {});
    options: {};
    collect(children: any): react_jsx_runtime.JSX.Element;
    sheetsRegistry: any;
    toString(): any;
    getStyleElement(props: any): React__default.DetailedReactHTMLElement<any, HTMLElement>;
}
...
interface StylesOptions {
    ...
    injectFirst?: boolean;
    jss?: Jss;
    sheetsCache?: {} | null | any;
    sheetsManager?: {} | null | any;
    sheetsRegistry?: {} | null | any;
}
...
declare namespace StylesProvider$1 {
    var propTypes: {
         ...
         */
        disableGeneration: PropTypes.Requireable<boolean>;
        /**
         * JSS's class name generator.
         */
        generateClassName: PropTypes.Requireable<(...args: any[]) => any>;
        /**
         ...
         * JSS's instance.
         */
        jss: PropTypes.Requireable<object>;
        /**
         * @ignore
         */
        serverGenerateClassName: PropTypes.Requireable<(...args: any[]) => any>;
        /**
         * @ignore
         *
         * Beta feature.
         ...
         */
        sheetsCache: PropTypes.Requireable<object>;
        /**
         * @ignore
         *
         ...
         */
        sheetsManager: PropTypes.Requireable<object>;
        /**
         * @ignore
         *
         * Collect the sheets.
         */
        sheetsRegistry: PropTypes.Requireable<object>;
    };
}
...
interface WithThemeCreatorOption<Theme = Theme> {
    defaultTheme?: Theme;
}
...
export { ServerStyleSheets, StylesProvider, createGenerateClassName, createStyles, getThemeProps, jssPreset, makeStyles, mergeClasses, propsToClassKey, styled, useThemes as useTheme, useThemeVariants, withStyles, withTheme, withThemeCreator };
